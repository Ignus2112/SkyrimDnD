...
public class NpcEnemySpwan
{
	...
	private static String[] enemylist3= {"Unbound Ice Atronach","NightBlade", "Assassin","Vigil Of Stendar","NightStaker Vampire","Beta WearBeast","Master WitchHunter","Adept Witch","Adept Mage", 
			"Adept Fire Mage", "Adept Storm Mage", "Adept Ice Mage" , "Adept Summoner Mage", "Adept Neco Mage", "Adept Illisuon Mage", };
	
	private static String[] enemylist4= {"Unbound Storm Atronach","Battle Summoner","Battle Mage","Master Vampire","Dark Brotherhood Assassin","Nightin Gale "," Hag Raven"," Expert Mage", "Expert Fire Mage", 
	...
	{
		PrintWriter spwan = (PrintWriter) new PrintWriter("EnemyThatSpwan.txt");
				for (int i=0; i<numOfEnemies;i++)
				{
					...
					case 5:
						...
						enemyRace=Race[rangeX.nextInt(Race.length+1-1)];
						enemyTypeSort();
						//npcBalance.npcBalanceRnk2();NpcEnemySpwan
						break;
					}
	...
	private static void enemyTypeSort()
	{
